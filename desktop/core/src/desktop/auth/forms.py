...
class AuthenticationForm(AuthAuthenticationForm):
  ...
  username = CharField(label=_t("Username"), widget=TextInput(attrs={'maxlength': 128, 'placeholder': _t("Username"), 'autocomplete': 'off', 'autofocus': 'autofocus', 'style':'width: 210px;'}))
